    ...
    <div className="QuartzMain overflow-hidden">
      <div className="sec__container Quartz__container" id="about">
        ...
        <div className="Quartz__content">
          ...
          <p className="Quartz__description leading-loose">
            At SILICA FLOOR INDUSTRIES we preferrably deal in two types of Quartz
            <li>Milky White Quartz</li>  
            <li>Snow White Quartz</li>  
          </p>

          <p className="Quartz__description leading-loose">
            Milky White Quartz, also known as Milk Quartz, gets its name from
            its milky or cloudy appearance. This characteristic is due to
            microscopic inclusions of gas or liquid trapped during the crystal
            formation process.Milky White Quartz is
            valued for its unique look and is often used in jewelry, decorative
            items, and sometimes in industrial applications where its aesthetic
            appeal is desirable.
          </p>
          <p className="Quartz__description leading-loose">
            Snow White Quartz is a high-quality variety of quartz known for its
            pure and uniform white color. Unlike Milky White Quartz, Snow White
            Quartz lacks the cloudy appearance caused by inclusions. It is
            highly prized for its clarity and brightness, making it a popular
            choice for countertops, flooring, tiles, and decorative stone
            applications in interior design. Snow White Quartz is favored for
            its elegant and clean look, which can enhance the aesthetic appeal
            of spaces and add a sense of luxury.
          </p>
        </div>
      </div>
      <div className="Quartz-products">
      ...
      <div className="applications flex px-auto mx-auto ">
        ...
        <div className="pt-8 md:pl-24 md:ml-10 ">
          ...
          <ul className="applications-list leading-loose">
            <li>
              Ceramics: Quartz is used in the manufacturing of ceramicsto
              improve itsstrength and durability.
            </li>
            <li>
              Glass Manufacturing: Quartz grains are used in the manufacturing
              of glassto improve its transparency and durability.
            </li>
            <li>
              Construction: Quartz stone is widely used in the construction
              industry for making countertops, flooring, and wall cladding.
            </li>
            <li>
              Electronics: Quartz crystals are used in electronic devicessuch as
              watches, clocks, and computersto provide accurate timing.
            </li>
            <li>
              Paints and Coatings: Quartz powderis used as a filler material in
              paints and coatingsto improve their durability and scratch
              resistance.
            </li>
          </ul>
        </div>
