  ...
  return (
    <div className="MinContainer">
      ...
      <div className="sec__container Quartz__container" id="about">
        ...
        Silica Floor Industries not only excels in manufacturing and exporting
            ...
            <p className="Mining__description leading-loose">  At Silica Floor Industries, mining isn't just
